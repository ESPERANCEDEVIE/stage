...
<body>
    ...
    <header>
        ...
        <div class="logo">
            <p><span>Esperance de Vie</span></p>
        </div>
        <ul class="menu">
        ...
        <div><a href="sfonction.php?uc=DemandeCo&action=demandeConnexion" class="login_btn"><button>Connexion</button></a></div>
...
<section id="adhérant">
            ...
            <div class="container">
                ...
                <form method="POST" action="sfonction.php?uc=benevole&action=verifinscription">
                    ...
                    <div class="form-group">
                        ...
                        <input type="tel" id="moblie" name="mobile" required>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <label for="mdpV">Vérification de mot de passe:</label>
                        <input type="password" id="mdpV" name="mdpV" required>
                    </div>
                    ...
                    <div>
                     ...
                     <input type="radio" id="benevole" name="pk" value="benevole" />
                     </div>

                     <div>
                    <input type="radio" id="particulier" name="pk" value="particulier" />
